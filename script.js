...
(function(){ var d=document.getElementById('rdv-date'); if(!d) return; var t=new Date(); var yyyy=t.getFullYear(); var mm=('0'+(t.getMonth()+1)).slice(-2); var dd=('0'+t.getDate()).slice(-2); d.min=yyyy+'-'+mm+'-'+dd; d.min=yyyy+'-'+mm+'-'+dd; })();
